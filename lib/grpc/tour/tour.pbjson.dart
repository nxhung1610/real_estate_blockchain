...
final $typed_data.Uint8List listTourRequestDescriptor = $convert.base64Decode(
    'Cg9MaXN0VG91clJlcXVlc3QSEgoEcGFnZRgBIAEoBVIEcGFnZRISCgRzaXplGAIgASgFUgRzaXpl');
...
final $typed_data.Uint8List listTourAdminRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List tourInfoDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listTourResponseDescriptor = $convert.base64Decode(
    'ChBMaXN0VG91clJlc3BvbnNlEh8KC3N0YXR1c19jb2RlGAEgASgFUgpzdGF0dXNDb2RlEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USKAoEZGF0YRgDIAEoCzIULnBiLlRvdXJMaXN0UmVzcERhdGFSBGRhdGE=');
...
final $typed_data.Uint8List tourListRespDataDescriptor = $convert.base64Decode(
    'ChBUb3VyTGlzdFJlc3BEYXRhEhQKBXRvdGFsGAEgASgFUgV0b3RhbBIgCgRkYXRhGAIgAygLMgwucGIuVG91ckluZm9SBGRhdGE=');
...
final $typed_data.Uint8List tourRejectTourRequestDescriptor = $convert.base64Decode(
    'ChVUb3VyUmVqZWN0VG91clJlcXVlc3QSFwoHdG91cl9pZBgBIAEoBVIGdG91cklkEhYKBnJlYXNvbhgCIAEoCVIGcmVhc29u');
...
final $typed_data.Uint8List tourAssignStaffForTourRequestDescriptor =
    $convert.base64Decode(
        'Ch1Ub3VyQXNzaWduU3RhZmZGb3JUb3VyUmVxdWVzdBIXCgd0b3VyX2lkGAEgASgFUgZ0b3VySWQSHwoFc3RhZmYYAiABKAsyCS5wYi5BVXNlclIFc3RhZmY=');
