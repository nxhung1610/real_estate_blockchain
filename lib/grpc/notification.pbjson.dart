...
final $typed_data.Uint8List getNotificationRequestDescriptor = $convert.base64Decode('ChZHZXROb3RpZmljYXRpb25SZXF1ZXN0EicKD25vdGlmaWNhdGlvbl9pZBgBIAEoCVIObm90aWZpY2F0aW9uSWQ=');
...
const NotificationResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'data', '3': 3, '4': 1, '5': 11, '6': '.pb.UserNotification', '10': 'data'},
  ],
};

/// Descriptor for `NotificationResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List notificationResponseDescriptor = $convert.base64Decode('ChROb3RpZmljYXRpb25SZXNwb25zZRIfCgtzdGF0dXNfY29kZRgBIAEoBVIKc3RhdHVzQ29kZRIYCgdtZXNzYWdlGAIgASgJUgdtZXNzYWdlEigKBGRhdGEYAyABKAsyFC5wYi5Vc2VyTm90aWZpY2F0aW9uUgRkYXRh');
...
const NotificationList$json = const {
  ...
  '2': const [
    const {'1': 'status_code', '3': 1, '4': 1, '5': 5, '10': 'statusCode'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'data', '3': 3, '4': 3, '5': 11, '6': '.pb.UserNotification', '10': 'data'},
  ],
};

/// Descriptor for `NotificationList`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List notificationListDescriptor = $convert.base64Decode('ChBOb3RpZmljYXRpb25MaXN0Eh8KC3N0YXR1c19jb2RlGAEgASgFUgpzdGF0dXNDb2RlEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USKAoEZGF0YRgDIAMoCzIULnBiLlVzZXJOb3RpZmljYXRpb25SBGRhdGE=');
...
final $typed_data.Uint8List userNotificationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List listNotificationRequestDescriptor = $convert.base64Decode('ChdMaXN0Tm90aWZpY2F0aW9uUmVxdWVzdBISCgRwYWdlGAEgASgFUgRwYWdlEhIKBHNpemUYAiABKAVSBHNpemUSGAoHa2V5d29yZBgDIAEoCVIHa2V5d29yZA==');
@$core.Deprecated('Use mQNotificationDataDescriptor instead')
const MQNotificationData$json = const {
  '1': 'MQNotificationData',
  '2': const [
    const {'1': 'notification', '3': 1, '4': 1, '5': 11, '6': '.pb.UserNotification', '10': 'notification'},
...
final $typed_data.Uint8List mQNotificationDataDescriptor = $convert.base64Decode('ChJNUU5vdGlmaWNhdGlvbkRhdGESOAoMbm90aWZpY2F0aW9uGAEgASgLMhQucGIuVXNlck5vdGlmaWNhdGlvblIMbm90aWZpY2F0aW9uEiQKDXNlbmRfdG9fdG9waWMYAiADKAlSDXNlbmRfdG9fdG9waWM=');
...
final $typed_data.Uint8List testNotificationRequestDescriptor = $convert.base64Decode('ChdUZXN0Tm90aWZpY2F0aW9uUmVxdWVzdBIeCgt0b191c2VyX2lkcxgBIAMoBVIJdG9Vc2VySWRz');
