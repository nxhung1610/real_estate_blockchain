...
final $typed_data.Uint8List responseBoolDescriptor = $convert.base64Decode('CgxSZXNwb25zZUJvb2wSHwoLc3RhdHVzX2NvZGUYASABKAVSCnN0YXR1c0NvZGUSGAoHbWVzc2FnZRgCIAEoCVIHbWVzc2FnZRISCgRkYXRhGAMgASgIUgRkYXRh');
...
final $typed_data.Uint8List aRealEstateImageDescriptor = $convert.base64Decode('ChBBUmVhbEVzdGF0ZUltYWdlEg4KAmlkGAEgASgFUgJpZBIQCgN1cmwYAiABKAlSA3VybBIUCgV3aWR0aBgDIAEoBVIFd2lkdGgSFgoGaGVpZ2h0GAQgASgFUgZoZWlnaHQSHQoKY2xvdWRfbmFtZRgFIAEoCVIJY2xvdWROYW1lEhwKCWV4dGVuc2lvbhgGIAEoCVIJZXh0ZW5zaW9uEhkKCG93bmVyX2lkGAcgASgFUgdvd25lcklk');
...
final $typed_data.Uint8List aRealEstateAmenityDescriptor = $convert.base64Decode('ChJBUmVhbEVzdGF0ZUFtZW5pdHkSDgoCaWQYASABKAVSAmlkEhIKBG5hbWUYAiABKAlSBG5hbWU=');
...
final $typed_data.Uint8List aRealEstateTypeDescriptor = $convert.base64Decode('Cg9BUmVhbEVzdGF0ZVR5cGUSDgoCaWQYASABKAVSAmlkEhIKBG5hbWUYAiABKAlSBG5hbWU=');
...
const ARealEstate$json = const {
  ...
  '2': const [
    ...
    const {'1': 'balcony_facing', '3': 18, '4': 1, '5': 9, '10': 'balconyFacing'},
    ...
    const {'1': 'amenities', '3': 25, '4': 3, '5': 11, '6': '.pb.ARealEstateAmenity', '10': 'amenities'},
    const {'1': 'images', '3': 26, '4': 3, '5': 11, '6': '.pb.ARealEstateImage', '10': 'images'},
  ],
};

/// Descriptor for `ARealEstate`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List aRealEstateDescriptor = $convert.base64Decode('');
...
const AUser$json = const {
  ...
  '2': const [
    ...
    const {'1': 'identity_number', '3': 11, '4': 1, '5': 9, '10': 'identityNumber'},
  ],
};

/// Descriptor for `AUser`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List aUserDescriptor = $convert.base64Decode('');
