...
import '../data/auth/infrastructure/remote/auth_repository.dart' as _i58;
...
import '../data/connection/domain/i_connection_repository.dart' as _i59;
import '../data/connection/infrastructure/connection_repository.dart' as _i60;
import '../data/core/data.dart' as _i15;
import '../data/core/infrastructure/infrastructure.dart' as _i82;
...
import '../data/core/module.dart' as _i81;
...
import '../data/notification/domain/i_notification_repository.dart' as _i61;
...
import '../data/real_estate/domain/i_real_estate_repository.dart' as _i42;
import '../data/real_estate/infrastructure/real_estate_repository.dart' as _i27;
import '../data/tour/domain/i_tour_repository.dart' as _i63;
import '../data/tour/infrastructure/tour_repository.dart' as _i64;
...
import '../feature/auth/application/application.dart' as _i67;
import '../feature/auth/application/auth_bloc.dart' as _i77;
import '../feature/auth/application/forgot_password/forgot_password_bloc.dart'
    as _i79;
import '../feature/auth/application/login_bloc.dart' as _i65;
import '../feature/auth/application/register_bloc.dart' as _i70;
import '../feature/bid/application/bid_bloc.dart' as _i50;
import '../feature/common/application/address/address_builder_cubit.dart'
    as _i48;
import '../feature/connectivity/application/connectivity_bloc.dart' as _i78;
import '../feature/discover/application/discover_bloc.dart' as _i54;
import '../feature/general/application/general_bloc.dart' as _i6;
import '../feature/home/application/home_bloc.dart' as _i55;
import '../feature/house_add_new/application/house_add_new_bloc.dart' as _i56;
...
import '../feature/message/application/chat_room_bloc/chat_room_bloc_params.dart'
    as _i52;
import '../feature/message/application/message_bloc/message_bloc.dart' as _i66;
import '../feature/my_home/application/my_home_bloc.dart' as _i34;
import '../feature/notification/application/notification_bloc.dart' as _i69;
...
import '../feature/real_estate/config/real_estate_config_bloc.dart' as _i38;
...
import '../feature/real_estate/favorites/application/favorites/real_estate_favorites_bloc.dart'
    as _i40;
import '../feature/search/application/search_bloc.dart' as _i41;
import '../feature/setting/application/setting_bloc.dart' as _i43;
import '../feature/tour/list/application/tour_own_bloc.dart' as _i73;
import '../feature/tour/review/application/tour_review_bloc.dart' as _i74;
import '../feature/tour/review/model/tour_review_params.dart' as _i75;
import '../feature/tour/schedule_tour/application/schedule_tour_bloc.dart'
    as _i71;
import '../feature/tour/schedule_tour/model/schedule_tour_params.dart' as _i72;
...
import '../grpc/grpc_module.dart' as _i80;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i38.RealEstateConfigBloc>(
      () => _i38.RealEstateConfigBloc(gh<_i26.IRealEstateRepository>()));
  gh.factoryParam<_i39.RealEstateDetailBloc, String, dynamic>((
    id,
    _,
  ) =>
      _i39.RealEstateDetailBloc(
        id,
        gh<_i33.MessageRepository>(),
        gh<_i26.IRealEstateRepository>(),
      ));
  gh.factory<_i40.RealEstateFavoritesBloc>(
      () => _i40.RealEstateFavoritesBloc(gh<_i26.IRealEstateRepository>()));
  gh.factory<_i41.SearchBloc>(
      () => _i41.SearchBloc(gh<_i42.IRealEstateRepository>()));
  ...
  gh.factoryParam<_i50.BidBloc, String, dynamic>((
    id,
    _,
  ) =>
      _i50.BidBloc(
        id,
        gh<_i42.IRealEstateRepository>(),
      ));
  gh.factoryParam<_i51.ChatRoomBloc, _i52.ChatRoomBlocParams, dynamic>((
    params,
    _,
  ) =>
      _i51.ChatRoomBloc(
  ...
  gh.factoryParam<_i53.CreatePostBloc, String, dynamic>((
    reId,
    _,
  ) =>
      _i53.CreatePostBloc(
  ...
  gh.factory<_i54.DiscoverBloc>(
      () => _i54.DiscoverBloc(gh<_i26.IRealEstateRepository>()));
  gh.factory<_i55.HomeBloc>(() => _i55.HomeBloc(
        gh<_i26.IRealEstateRepository>(),
        gh<_i24.IProvincesRepository>(),
      ));
  gh.factory<_i56.HouseAddNewBloc>(() => _i56.HouseAddNewBloc(
        gh<_i20.IFileRepository>(),
        gh<_i26.IRealEstateRepository>(),
      ));
  gh.factoryParam<_i57.HouseProcessAddressBloc, _i9.ValidateSubcriber, dynamic>(
      (
    _subcriber,
    _,
  ) =>
          _i57.HouseProcessAddressBloc(
            gh<_i24.IProvincesRepository>(),
            _subcriber,
          ));
  gh.lazySingleton<_i16.IAuthRepository>(() => _i58.AuthRepository(
        gh<_i4.ApiRemote>(),
        gh<_i16.LoginMapper>(),
        gh<_i16.IAuthLocalRepository>(),
      ));
  gh.lazySingleton<_i59.IConnectionRepository>(() => _i60.ConnectionRepository(
      connectivity: gh<_i30.InternetConnectionChecker>()));
  gh.lazySingleton<_i61.INotificationRespository>(() =>
      _i62.NotificationRepository(gh<_i35.NotificationServiceClient>(
          instanceName: 'GRPC_NOTIFICATION_SERVICE')));
  gh.lazySingleton<_i63.ITourRepository>(() => _i64.TourRepository(
      gh<_i45.TourServiceClient>(instanceName: 'GRPC_TOUR_SERVICE')));
  gh.factory<_i65.LoginBloc>(() => _i65.LoginBloc(gh<_i16.IAuthRepository>()));
  gh.factoryParam<_i66.MessageBloc, _i67.AuthBloc, String>((
    authBloc,
    chatWSUrl,
  ) =>
      _i66.MessageBloc(
  ...
  gh.factory<_i68.NotificationAppBloc>(
      () => _i68.NotificationAppBloc(gh<_i61.INotificationRespository>()));
  gh.factory<_i69.NotificationBloc>(
      () => _i69.NotificationBloc(gh<_i61.INotificationRespository>()));
  gh.factory<_i70.RegisterBloc>(
      () => _i70.RegisterBloc(gh<_i16.IAuthRepository>()));
  gh.factoryParam<_i71.ScheduleTourBloc, _i72.ScheduleTourParams, dynamic>((
    params,
    _,
  ) =>
      _i71.ScheduleTourBloc(
        gh<_i63.ITourRepository>(),
        params,
      ));
  gh.factory<_i73.TourOwnBloc>(() => _i73.TourOwnBloc(
        gh<_i63.ITourRepository>(),
        gh<_i26.IRealEstateRepository>(),
      ));
  gh.factoryParam<_i74.TourReviewBloc, _i75.TourReviewParams, dynamic>((
    params,
    _,
  ) =>
      _i74.TourReviewBloc(
  ...
  gh.factory<_i76.UserChangePasswordBloc>(
      () => _i76.UserChangePasswordBloc(gh<_i16.IAuthRepository>()));
  ...
  gh.factory<_i78.ConnectivityBloc>(
      () => _i78.ConnectivityBloc(gh<_i59.IConnectionRepository>()));
  gh.factory<_i79.ForgotPasswordBloc>(
      () => _i79.ForgotPasswordBloc(gh<_i16.IAuthRepository>()));
  return getIt;
}

class _$GrpcModule extends _i80.GrpcModule {}

class _$CoreData extends _i81.CoreData {}

class _$InfrastructureModule extends _i82.InfrastructureModule {}
