...
import '../data/core/infrastructure/infrastructure.dart' as _i75;
...
import '../data/core/module.dart' as _i74;
...
import '../feature/auth/application/auth_bloc.dart' as _i70;
...
import '../feature/common/application/address/address_builder_cubit.dart'
    as _i43;
import '../feature/connectivity/application/connectivity_bloc.dart' as _i71;
...
import '../feature/tour/list/application/tour_own_bloc.dart' as _i66;
import '../feature/tour/review/application/tour_review_bloc.dart' as _i67;
import '../feature/tour/review/model/tour_review_params.dart' as _i68;
...
import '../grpc/grpc_module.dart' as _i73;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factoryParam<_i64.ScheduleTourBloc, _i65.ScheduleTourParams, dynamic>((
    params,
    _,
  ) =>
      _i64.ScheduleTourBloc(
        gh<_i56.ITourRepository>(),
        params,
      ));
  gh.factory<_i66.TourOwnBloc>(() => _i66.TourOwnBloc(
        gh<_i56.ITourRepository>(),
        gh<_i22.IRealEstateRepository>(),
      ));
  gh.factoryParam<_i67.TourReviewBloc, _i68.TourReviewParams, dynamic>((
    params,
    _,
  ) =>
      _i67.TourReviewBloc(
  ...
  gh.factory<_i71.ConnectivityBloc>(
      () => _i71.ConnectivityBloc(gh<_i52.IConnectionRepository>()));
  gh.factory<_i72.ForgotPasswordBloc>(
      () => _i72.ForgotPasswordBloc(gh<_i16.IAuthRepository>()));
  return getIt;
}

class _$GrpcModule extends _i73.GrpcModule {}

class _$CoreData extends _i74.CoreData {}

class _$InfrastructureModule extends _i75.InfrastructureModule {}
