...
import 'package:real_estate_blockchain/data/core/infrastructure/remote/api_remote.dart'
    as _i4;
import 'package:real_estate_blockchain/data/file/data.dart' as _i39;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i15.IAuthRepository>(() => _i41.AuthRepository(
        gh<_i4.ApiRemote>(),
        gh<_i15.LoginMapper>(),
        gh<_i15.IAuthLocalRepository>(),
      ));
  gh.factory<_i42.LoginBloc>(() => _i42.LoginBloc(gh<_i15.IAuthRepository>()));
  gh.factoryParam<_i43.MessageBloc, _i44.AuthBloc, dynamic>((
    authBloc,
    _,
  ) =>
      _i43.MessageBloc(
  ...
  gh.factory<_i45.RegisterBloc>(
      () => _i45.RegisterBloc(gh<_i15.IAuthRepository>()));
