...
import '../data/auth/infrastructure/remote/mapper/login_mapper.dart' as _i18;
...
import '../data/province/infrastructure/local/provinces_repository.dart'
    as _i16;
import '../feature/app/application/app_bloc.dart' as _i26;
import '../feature/auth/application/auth_bloc.dart' as _i27;
import '../feature/auth/application/login_bloc.dart' as _i17;
import '../feature/auth/application/register_bloc.dart' as _i25;
import '../feature/discover/application/discover_bloc.dart' as _i5;
import '../feature/home/application/home_bloc.dart' as _i6;
import '../feature/house_add_new/application/house_add_new_bloc.dart' as _i7;
...
import '../feature/house_add_new/application/house_process_real_info_bloc.dart'
    as _i8;
import '../feature/house_add_new/application/validate_subcriber.dart' as _i29;
import '../feature/main/application/main_cubit.dart' as _i19;
import '../feature/message/application/message_bloc.dart' as _i20;
import '../feature/message/application/message_chat_bloc.dart' as _i21;
import '../feature/my_home/application/my_home_bloc.dart' as _i22;
import '../feature/onboarding/application/onboarding_bloc.dart' as _i23;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i7.HouseAddNewBloc>(() => _i7.HouseAddNewBloc());
  gh.factory<_i8.HouseProcessRealInfoBloc>(
      () => _i8.HouseProcessRealInfoBloc());
  ...
  gh.factory<_i17.LoginBloc>(() => _i17.LoginBloc(get<_i12.IAuthRepository>()));
  gh.lazySingleton<_i18.LoginMapper>(() => _i18.LoginMapper());
  gh.factory<_i19.MainCubit>(() => _i19.MainCubit());
  gh.factory<_i20.MessageBloc>(() => _i20.MessageBloc());
  gh.factory<_i21.MessageChatBloc>(() => _i21.MessageChatBloc());
  gh.factory<_i22.MyHomeBloc>(() => _i22.MyHomeBloc());
  gh.factory<_i23.OnboardingBloc>(
      () => _i23.OnboardingBloc(get<_i9.IAppConfigLocalRepository>()));
  gh.factory<_i24.ProfileBloc>(() => _i24.ProfileBloc());
  gh.factory<_i25.RegisterBloc>(
      () => _i25.RegisterBloc(get<_i12.IAuthRepository>()));
  gh.factory<_i26.AppBloc>(
      () => _i26.AppBloc(get<_i9.IAppConfigLocalRepository>()));
  gh.factory<_i27.AuthBloc>(() => _i27.AuthBloc(
      get<_i12.IAuthLocalRepository>(),
      get<_i12.IAuthRepository>(),
      get<_i11.ApiRemote>()));
  gh.factoryParam<_i28.HouseProcessAddressBloc, _i29.ValidateSubcriber,
          dynamic>(
      (_subcriber, _) => _i28.HouseProcessAddressBloc(
