...
import '../data/auth/domain/entities/info/user.dart' as _i46;
import '../data/auth/infrastructure/local/auth_local_repository.dart' as _i17;
import '../data/auth/infrastructure/remote/auth_repository.dart' as _i57;
...
import '../data/connection/domain/i_connection_repository.dart' as _i58;
import '../data/connection/infrastructure/connection_repository.dart' as _i59;
import '../data/core/data.dart' as _i15;
import '../data/core/infrastructure/infrastructure.dart' as _i81;
...
import '../data/core/module.dart' as _i80;
...
import '../data/notification/domain/i_notification_repository.dart' as _i60;
...
import '../data/tour/domain/i_tour_repository.dart' as _i62;
import '../data/tour/infrastructure/tour_repository.dart' as _i63;
import '../data/user/domain/i_user_repostiory.dart' as _i28;
import '../data/user/infrastructure/user_repository.dart' as _i29;
import '../feature/app/application/app_bloc.dart' as _i48;
import '../feature/auth/application/application.dart' as _i66;
import '../feature/auth/application/auth_bloc.dart' as _i76;
import '../feature/auth/application/forgot_password/forgot_password_bloc.dart'
    as _i78;
import '../feature/auth/application/login_bloc.dart' as _i64;
import '../feature/auth/application/register_bloc.dart' as _i69;
import '../feature/bid/application/bid_bloc.dart' as _i49;
import '../feature/common/application/address/address_builder_cubit.dart'
    as _i47;
import '../feature/connectivity/application/connectivity_bloc.dart' as _i77;
import '../feature/discover/application/discover_bloc.dart' as _i53;
import '../feature/general/application/general_bloc.dart' as _i6;
import '../feature/home/application/home_bloc.dart' as _i54;
import '../feature/house_add_new/application/house_add_new_bloc.dart' as _i55;
...
import '../feature/message/application/chat_room_bloc/chat_room_bloc_params.dart'
    as _i51;
import '../feature/message/application/message_bloc/message_bloc.dart' as _i65;
import '../feature/my_home/application/my_home_bloc.dart' as _i34;
import '../feature/notification/application/notification_bloc.dart' as _i68;
...
import '../feature/real_estate/config/real_estate_config_bloc.dart' as _i37;
...
import '../feature/real_estate/favorites/application/favorites/real_estate_favorites_bloc.dart'
    as _i39;
import '../feature/search/application/search_bloc.dart' as _i40;
import '../feature/setting/application/setting_bloc.dart' as _i42;
import '../feature/tour/list/application/tour_own_bloc.dart' as _i72;
import '../feature/tour/review/application/tour_review_bloc.dart' as _i73;
import '../feature/tour/review/model/tour_review_params.dart' as _i74;
import '../feature/tour/schedule_tour/application/schedule_tour_bloc.dart'
    as _i70;
import '../feature/tour/schedule_tour/model/schedule_tour_params.dart' as _i71;
import '../feature/user/change_password/application/user_change_password_bloc.dart'
    as _i75;
import '../feature/user/profile/application/user_profile_bloc.dart' as _i45;
import '../grpc/grpc_module.dart' as _i79;
import '../grpc/grpc_service.dart' as _i7;
import '../grpc/notification/service.pbgrpc.dart' as _i35;
import '../grpc/tour/service.pbgrpc.dart' as _i44;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i37.RealEstateConfigBloc>(
      () => _i37.RealEstateConfigBloc(gh<_i26.IRealEstateRepository>()));
  gh.factoryParam<_i38.RealEstateDetailBloc, String, dynamic>((
    id,
    _,
  ) =>
      _i38.RealEstateDetailBloc(
        id,
        gh<_i33.MessageRepository>(),
        gh<_i26.IRealEstateRepository>(),
      ));
  gh.factory<_i39.RealEstateFavoritesBloc>(
      () => _i39.RealEstateFavoritesBloc(gh<_i26.IRealEstateRepository>()));
  gh.factory<_i40.SearchBloc>(
      () => _i40.SearchBloc(gh<_i41.IRealEstateRepository>()));
  gh.factory<_i42.SettingBloc>(
      () => _i42.SettingBloc(gh<_i28.IUserRepistory>()));
  await gh.factoryAsync<_i43.SharedPreferences>(
    () => coreData.sharedPreferences(),
    preResolve: true,
  );
  gh.lazySingleton<_i44.TourServiceClient>(
  ...
  gh.factoryParam<_i45.UserProfileBloc, _i46.User, dynamic>((
    user,
    _,
  ) =>
      _i45.UserProfileBloc(
        gh<_i20.IFileRepository>(),
        user,
        gh<_i28.IUserRepistory>(),
      ));
  gh.factory<_i47.AddressBuilderCubit>(
      () => _i47.AddressBuilderCubit(gh<_i24.IProvincesRepository>()));
  gh.factory<_i48.AppBloc>(
      () => _i48.AppBloc(gh<_i13.IAppConfigLocalRepository>()));
  gh.factoryParam<_i49.BidBloc, String, dynamic>((
    id,
    _,
  ) =>
      _i49.BidBloc(
  ...
  gh.factoryParam<_i50.ChatRoomBloc, _i51.ChatRoomBlocParams, dynamic>((
    params,
    _,
  ) =>
      _i50.ChatRoomBloc(
  ...
  gh.factoryParam<_i52.CreatePostBloc, String, dynamic>((
    reId,
    _,
  ) =>
      _i52.CreatePostBloc(
  ...
  gh.factory<_i53.DiscoverBloc>(
      () => _i53.DiscoverBloc(gh<_i26.IRealEstateRepository>()));
  gh.factory<_i54.HomeBloc>(() => _i54.HomeBloc(
        gh<_i26.IRealEstateRepository>(),
        gh<_i24.IProvincesRepository>(),
      ));
  gh.factory<_i55.HouseAddNewBloc>(() => _i55.HouseAddNewBloc(
        gh<_i20.IFileRepository>(),
        gh<_i26.IRealEstateRepository>(),
      ));
  gh.factoryParam<_i56.HouseProcessAddressBloc, _i9.ValidateSubcriber, dynamic>(
      (
    _subcriber,
    _,
  ) =>
          _i56.HouseProcessAddressBloc(
            gh<_i24.IProvincesRepository>(),
            _subcriber,
          ));
  gh.lazySingleton<_i16.IAuthRepository>(() => _i57.AuthRepository(
        gh<_i4.ApiRemote>(),
        gh<_i16.LoginMapper>(),
        gh<_i16.IAuthLocalRepository>(),
      ));
  gh.lazySingleton<_i58.IConnectionRepository>(() => _i59.ConnectionRepository(
      connectivity: gh<_i30.InternetConnectionChecker>()));
  gh.lazySingleton<_i60.INotificationRespository>(() =>
      _i61.NotificationRepository(gh<_i35.NotificationServiceClient>(
          instanceName: 'GRPC_NOTIFICATION_SERVICE')));
  gh.lazySingleton<_i62.ITourRepository>(() => _i63.TourRepository(
      gh<_i44.TourServiceClient>(instanceName: 'GRPC_TOUR_SERVICE')));
  gh.factory<_i64.LoginBloc>(() => _i64.LoginBloc(gh<_i16.IAuthRepository>()));
  gh.factoryParam<_i65.MessageBloc, _i66.AuthBloc, String>((
    authBloc,
    chatWSUrl,
  ) =>
      _i65.MessageBloc(
  ...
  gh.factory<_i67.NotificationAppBloc>(
      () => _i67.NotificationAppBloc(gh<_i60.INotificationRespository>()));
  gh.factory<_i68.NotificationBloc>(
      () => _i68.NotificationBloc(gh<_i60.INotificationRespository>()));
  gh.factory<_i69.RegisterBloc>(
      () => _i69.RegisterBloc(gh<_i16.IAuthRepository>()));
  gh.factoryParam<_i70.ScheduleTourBloc, _i71.ScheduleTourParams, dynamic>((
    params,
    _,
  ) =>
      _i70.ScheduleTourBloc(
        gh<_i62.ITourRepository>(),
        params,
      ));
  gh.factory<_i72.TourOwnBloc>(() => _i72.TourOwnBloc(
        gh<_i62.ITourRepository>(),
        gh<_i26.IRealEstateRepository>(),
      ));
  gh.factoryParam<_i73.TourReviewBloc, _i74.TourReviewParams, dynamic>((
    params,
    _,
  ) =>
      _i73.TourReviewBloc(
  ...
  gh.factory<_i75.UserChangePasswordBloc>(
      () => _i75.UserChangePasswordBloc(gh<_i16.IAuthRepository>()));
  ...
  gh.factory<_i77.ConnectivityBloc>(
      () => _i77.ConnectivityBloc(gh<_i58.IConnectionRepository>()));
  gh.factory<_i78.ForgotPasswordBloc>(
      () => _i78.ForgotPasswordBloc(gh<_i16.IAuthRepository>()));
  return getIt;
}

class _$GrpcModule extends _i79.GrpcModule {}

class _$CoreData extends _i80.CoreData {}

class _$InfrastructureModule extends _i81.InfrastructureModule {}
