...
import '../data/auth/domain/entities/info/user.dart' as _i41;
import '../data/auth/infrastructure/local/auth_local_repository.dart' as _i17;
import '../data/auth/infrastructure/remote/auth_repository.dart' as _i50;
import '../data/auth/infrastructure/remote/mapper/login_mapper.dart' as _i27;
import '../data/connection/domain/i_connection_repository.dart' as _i51;
import '../data/connection/infrastructure/connection_repository.dart' as _i52;
import '../data/core/data.dart' as _i15;
import '../data/core/infrastructure/infrastructure.dart' as _i67;
...
import '../data/core/module.dart' as _i66;
...
import '../data/notification/domain/i_notification_repository.dart' as _i53;
...
import '../feature/app/application/app_bloc.dart' as _i43;
import '../feature/auth/application/application.dart' as _i57;
import '../feature/auth/application/auth_bloc.dart' as _i62;
import '../feature/auth/application/forgot_password/forgot_password_bloc.dart'
    as _i64;
import '../feature/auth/application/login_bloc.dart' as _i55;
import '../feature/auth/application/register_bloc.dart' as _i60;
import '../feature/common/application/address/address_builder_cubit.dart'
    as _i42;
import '../feature/connectivity/application/connectivity_bloc.dart' as _i63;
import '../feature/discover/application/discover_bloc.dart' as _i46;
import '../feature/general/application/general_bloc.dart' as _i6;
import '../feature/home/application/home_bloc.dart' as _i47;
import '../feature/house_add_new/application/house_add_new_bloc.dart' as _i48;
...
import '../feature/message/application/chat_room_bloc/chat_room_bloc_params.dart'
    as _i45;
import '../feature/message/application/message_bloc/message_bloc.dart' as _i56;
import '../feature/my_home/application/my_home_bloc.dart' as _i30;
import '../feature/notification/application/notification_bloc.dart' as _i59;
...
import '../feature/user/change_password/application/user_change_password_bloc.dart'
    as _i61;
import '../feature/user/profile/application/user_profile_bloc.dart' as _i40;
import '../grpc/grpc_module.dart' as _i65;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factoryParam<_i40.UserProfileBloc, _i41.User, dynamic>((
    user,
    _,
  ) =>
      _i40.UserProfileBloc(
        gh<_i18.IFileRepository>(),
        user,
        gh<_i24.IUserRepistory>(),
      ));
  gh.factory<_i42.AddressBuilderCubit>(
      () => _i42.AddressBuilderCubit(gh<_i20.IProvincesRepository>()));
  gh.factory<_i43.AppBloc>(
      () => _i43.AppBloc(gh<_i13.IAppConfigLocalRepository>()));
  gh.factoryParam<_i44.ChatRoomBloc, _i45.ChatRoomBlocParams, dynamic>((
    params,
    _,
  ) =>
      _i44.ChatRoomBloc(
  ...
  gh.factory<_i46.DiscoverBloc>(
      () => _i46.DiscoverBloc(gh<_i22.IRealEstateRepository>()));
  gh.factory<_i47.HomeBloc>(() => _i47.HomeBloc(
        gh<_i22.IRealEstateRepository>(),
        gh<_i20.IProvincesRepository>(),
      ));
  gh.factory<_i48.HouseAddNewBloc>(() => _i48.HouseAddNewBloc(
        gh<_i18.IFileRepository>(),
        gh<_i22.IRealEstateRepository>(),
      ));
  gh.factoryParam<_i49.HouseProcessAddressBloc, _i9.ValidateSubcriber, dynamic>(
      (
    _subcriber,
    _,
  ) =>
          _i49.HouseProcessAddressBloc(
            gh<_i20.IProvincesRepository>(),
            _subcriber,
          ));
  gh.lazySingleton<_i16.IAuthRepository>(() => _i50.AuthRepository(
        gh<_i4.ApiRemote>(),
        gh<_i16.LoginMapper>(),
        gh<_i16.IAuthLocalRepository>(),
      ));
  gh.lazySingleton<_i51.IConnectionRepository>(() => _i52.ConnectionRepository(
      connectivity: gh<_i26.InternetConnectionChecker>()));
  gh.lazySingleton<_i53.INotificationRespository>(() =>
      _i54.NotificationRepository(gh<_i31.NotificationServiceClient>(
          instanceName: 'GRPC_NOTIFICATION_SERVICE')));
  gh.factory<_i55.LoginBloc>(() => _i55.LoginBloc(gh<_i16.IAuthRepository>()));
  gh.factoryParam<_i56.MessageBloc, _i57.AuthBloc, String>((
    authBloc,
    chatWSUrl,
  ) =>
      _i56.MessageBloc(
  ...
  gh.factory<_i58.NotificationAppBloc>(
      () => _i58.NotificationAppBloc(gh<_i53.INotificationRespository>()));
  gh.factory<_i59.NotificationBloc>(
      () => _i59.NotificationBloc(gh<_i53.INotificationRespository>()));
  gh.factory<_i60.RegisterBloc>(
      () => _i60.RegisterBloc(gh<_i16.IAuthRepository>()));
  gh.factory<_i61.UserChangePasswordBloc>(
      () => _i61.UserChangePasswordBloc(gh<_i16.IAuthRepository>()));
  ...
  gh.factory<_i63.ConnectivityBloc>(
      () => _i63.ConnectivityBloc(gh<_i51.IConnectionRepository>()));
  gh.factory<_i64.ForgotPasswordBloc>(
      () => _i64.ForgotPasswordBloc(gh<_i16.IAuthRepository>()));
  return getIt;
}

class _$GrpcModule extends _i65.GrpcModule {}

class _$CoreData extends _i66.CoreData {}

class _$InfrastructureModule extends _i67.InfrastructureModule {}
