...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i30.RealEstateFavoritesBloc>(
      () => _i30.RealEstateFavoritesBloc(gh<_i19.IRealEstateRepository>()));
  gh.factory<_i31.SearchBloc>(
      () => _i31.SearchBloc(gh<_i32.IRealEstateRepository>()));
  gh.factory<_i33.AddressBuilderCubit>(
      () => _i33.AddressBuilderCubit(gh<_i17.IProvincesRepository>()));
  gh.factory<_i34.AppBloc>(
      () => _i34.AppBloc(gh<_i10.IAppConfigLocalRepository>()));
  ...
  gh.factory<_i37.DiscoverBloc>(
      () => _i37.DiscoverBloc(gh<_i19.IRealEstateRepository>()));
  ...
  gh.factoryParam<_i40.HouseProcessAddressBloc, _i6.ValidateSubcriber, dynamic>(
      (
    _subcriber,
    _,
  ) =>
  ...
  gh.lazySingleton<_i13.IAuthRepository>(() => _i41.AuthRepository(
        gh<_i4.ApiRemote>(),
        gh<_i13.LoginMapper>(),
        gh<_i13.IAuthLocalRepository>(),
      ));
  gh.factory<_i42.LoginBloc>(() => _i42.LoginBloc(gh<_i13.IAuthRepository>()));
  gh.factoryParam<_i43.MessageBloc, _i44.AuthBloc, String>((
    authBloc,
    chatWSUrl,
  ) =>
      _i43.MessageBloc(
  ...
  gh.factory<_i45.RegisterBloc>(
      () => _i45.RegisterBloc(gh<_i13.IAuthRepository>()));
