...
import '../data/auth/domain/entities/info/user.dart' as _i56;
import '../data/auth/infrastructure/local/auth_local_repository.dart' as _i21;
import '../data/auth/infrastructure/remote/auth_repository.dart' as _i73;
...
import '../data/connection/domain/i_connection_repository.dart' as _i74;
import '../data/connection/infrastructure/connection_repository.dart' as _i75;
import '../data/core/data.dart' as _i19;
import '../data/core/infrastructure/infrastructure.dart' as _i101;
...
import '../data/core/module.dart' as _i100;
...
import '../data/map/i_map_repository.dart' as _i76;
import '../data/map/map_repository.dart' as _i77;
import '../data/message/infrastructure/message_repository.dart' as _i39;
import '../data/notification/domain/i_notification_repository.dart' as _i78;
...
import '../data/real_estate/domain/i_real_estate_repository.dart' as _i49;
import '../data/real_estate/infrastructure/real_estate_repository.dart' as _i33;
import '../data/tour/domain/i_tour_repository.dart' as _i80;
import '../data/tour/infrastructure/tour_repository.dart' as _i81;
import '../data/user/domain/i_user_repostiory.dart' as _i34;
import '../data/user/infrastructure/user_repository.dart' as _i35;
import '../feature/app/application/app_bloc.dart' as _i58;
import '../feature/auth/application/application.dart' as _i84;
import '../feature/auth/application/auth_bloc.dart' as _i94;
import '../feature/auth/application/forgot_password/forgot_password_bloc.dart'
    as _i98;
import '../feature/auth/application/login_bloc.dart' as _i82;
import '../feature/auth/application/register_bloc.dart' as _i87;
import '../feature/bid/detail/application/bid_detail_bloc.dart' as _i59;
import '../feature/bid/detail/model/bid_detail_params.dart' as _i60;
import '../feature/bid/detail/presentation/popup/cubit/bid_done_cubit_cubit.dart'
    as _i61;
import '../feature/bid/list/application/bid_list_bloc.dart' as _i62;
import '../feature/common/application/address/address_builder_cubit.dart'
    as _i57;
import '../feature/connectivity/application/connectivity_bloc.dart' as _i95;
import '../feature/dialogflow/application/dialogflow_bloc.dart' as _i96;
...
import '../feature/dialogflow/presentation/widget/estate/media/dialogflow_estate_media_cubit.dart'
    as _i9;
import '../feature/discover/application/discover_bloc.dart' as _i69;
import '../feature/general/application/general_bloc.dart' as _i10;
import '../feature/home/application/home_bloc.dart' as _i70;
import '../feature/house_add_new/application/house_add_new_bloc.dart' as _i71;
...
import '../feature/message/application/chat_room_bloc/chat_room_bloc_params.dart'
    as _i64;
import '../feature/message/application/message_bloc/message_bloc.dart' as _i83;
import '../feature/my_home/application/my_home_bloc.dart' as _i40;
import '../feature/notification/application/notification_bloc.dart' as _i86;
...
import '../feature/real_estate/news/application/real_estate_news_bloc/real_estate_news_bloc.dart'
    as _i50;
import '../feature/search/application/search_bloc.dart' as _i51;
import '../feature/setting/application/setting_bloc.dart' as _i52;
import '../feature/tour/list/application/tour_own_bloc.dart' as _i90;
import '../feature/tour/review/application/tour_review_bloc.dart' as _i91;
import '../feature/tour/review/model/tour_review_params.dart' as _i92;
import '../feature/tour/schedule_tour/application/schedule_tour_bloc.dart'
    as _i88;
import '../feature/tour/schedule_tour/model/schedule_tour_params.dart' as _i89;
import '../feature/user/change_password/application/user_change_password_bloc.dart'
    as _i93;
import '../feature/user/profile/application/user_profile_bloc.dart' as _i55;
import '../grpc/grpc_module.dart' as _i99;
import '../grpc/grpc_service.dart' as _i11;
import '../grpc/notification/service.pbgrpc.dart' as _i41;
import '../grpc/tour/service.pbgrpc.dart' as _i54;
import '../languages/languages.dart' as _i97;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i48.RealEstateNewsBloc>(
      () => _i48.RealEstateNewsBloc(gh<_i49.IRealEstateRepository>()));
  gh.factory<_i50.RealEstateNewsBloc>(
      () => _i50.RealEstateNewsBloc(gh<_i49.IRealEstateRepository>()));
  gh.factory<_i51.SearchBloc>(
      () => _i51.SearchBloc(gh<_i28.IPostRepository>()));
  gh.factory<_i52.SettingBloc>(
      () => _i52.SettingBloc(gh<_i34.IUserRepository>()));
  await gh.factoryAsync<_i53.SharedPreferences>(
    () => coreData.sharedPreferences(),
    preResolve: true,
  );
  gh.lazySingleton<_i54.TourServiceClient>(
  ...
  gh.factoryParam<_i55.UserProfileBloc, _i56.User, dynamic>((
    user,
    _,
  ) =>
      _i55.UserProfileBloc(
        gh<_i26.IFileRepository>(),
        user,
        gh<_i34.IUserRepository>(),
      ));
  gh.factory<_i57.AddressBuilderCubit>(
      () => _i57.AddressBuilderCubit(gh<_i30.IProvincesRepository>()));
  gh.factory<_i58.AppBloc>(
      () => _i58.AppBloc(gh<_i17.IAppConfigLocalRepository>()));
  gh.factoryParam<_i59.BidDetailBloc, _i60.BidDetailParams, dynamic>((
    params,
    _,
  ) =>
      _i59.BidDetailBloc(
        params,
        gh<_i49.IRealEstateRepository>(),
        gh<_i22.IBidRepository>(),
      ));
  gh.factory<_i61.BidDoneCubitCubit>(
      () => _i61.BidDoneCubitCubit(gh<_i39.MessageRepository>()));
  gh.factory<_i62.BidListBloc>(
      () => _i62.BidListBloc(gh<_i22.IBidRepository>()));
  gh.factoryParam<_i63.ChatRoomBloc, _i64.ChatRoomBlocParams, dynamic>((
    params,
    _,
  ) =>
      _i63.ChatRoomBloc(
  ...
  gh.factoryParam<_i65.CreateBidBloc, String, dynamic>((
    id,
    _,
  ) =>
      _i65.CreateBidBloc(
  ...
  gh.factoryParam<_i66.CreateBidBloc, String, dynamic>((
    id,
    _,
  ) =>
      _i66.CreateBidBloc(
  ...
  gh.factoryParam<_i67.CreatePostBloc, String, dynamic>((
    reId,
    _,
  ) =>
      _i67.CreatePostBloc(
  ...
  gh.factoryParam<_i68.CreatePostBloc, String, dynamic>((
    reId,
    _,
  ) =>
      _i68.CreatePostBloc(
  ...
  gh.factory<_i69.DiscoverBloc>(
      () => _i69.DiscoverBloc(gh<_i28.IPostRepository>()));
  gh.factory<_i70.HomeBloc>(() => _i70.HomeBloc(
        gh<_i32.IRealEstateRepository>(),
        gh<_i30.IProvincesRepository>(),
      ));
  gh.factory<_i71.HouseAddNewBloc>(() => _i71.HouseAddNewBloc(
        gh<_i26.IFileRepository>(),
        gh<_i32.IRealEstateRepository>(),
      ));
  gh.factoryParam<_i72.HouseProcessAddressBloc, _i13.ValidateSubcriber,
      dynamic>((
    _subcriber,
    _,
  ) =>
      _i72.HouseProcessAddressBloc(
        gh<_i30.IProvincesRepository>(),
        _subcriber,
      ));
  gh.lazySingleton<_i20.IAuthRepository>(() => _i73.AuthRepository(
        gh<_i5.ApiRemote>(),
        gh<_i20.LoginMapper>(),
        gh<_i20.IAuthLocalRepository>(),
      ));
  gh.lazySingleton<_i74.IConnectionRepository>(() => _i75.ConnectionRepository(
      connectivity: gh<_i36.InternetConnectionChecker>()));
  gh.lazySingleton<_i76.IMapRepository>(
      () => _i77.MapRepository(gh<_i30.IProvincesRepository>()));
  gh.lazySingleton<_i78.INotificationRespository>(() =>
      _i79.NotificationRepository(gh<_i41.NotificationServiceClient>(
          instanceName: 'GRPC_NOTIFICATION_SERVICE')));
  gh.lazySingleton<_i80.ITourRepository>(() => _i81.TourRepository(
      gh<_i54.TourServiceClient>(instanceName: 'GRPC_TOUR_SERVICE')));
  gh.factory<_i82.LoginBloc>(() => _i82.LoginBloc(gh<_i20.IAuthRepository>()));
  gh.factoryParam<_i83.MessageBloc, _i84.AuthBloc, String>((
    authBloc,
    chatWSUrl,
  ) =>
      _i83.MessageBloc(
  ...
  gh.factory<_i85.NotificationAppBloc>(
      () => _i85.NotificationAppBloc(gh<_i78.INotificationRespository>()));
  gh.factory<_i86.NotificationBloc>(
      () => _i86.NotificationBloc(gh<_i78.INotificationRespository>()));
  gh.factory<_i87.RegisterBloc>(
      () => _i87.RegisterBloc(gh<_i20.IAuthRepository>()));
  gh.factoryParam<_i88.ScheduleTourBloc, _i89.ScheduleTourParams, dynamic>((
    params,
    _,
  ) =>
      _i88.ScheduleTourBloc(
        gh<_i80.ITourRepository>(),
        params,
      ));
  gh.factory<_i90.TourOwnBloc>(() => _i90.TourOwnBloc(
        gh<_i80.ITourRepository>(),
        gh<_i32.IRealEstateRepository>(),
      ));
  gh.factoryParam<_i91.TourReviewBloc, _i92.TourReviewParams, dynamic>((
    params,
    _,
  ) =>
      _i91.TourReviewBloc(
  ...
  gh.factory<_i93.UserChangePasswordBloc>(
      () => _i93.UserChangePasswordBloc(gh<_i20.IAuthRepository>()));
  ...
  gh.factory<_i95.ConnectivityBloc>(
      () => _i95.ConnectivityBloc(gh<_i74.IConnectionRepository>()));
  gh.factoryParam<_i96.DialogflowBloc, _i97.S, String>((
    s,
    location,
  ) =>
      _i96.DialogflowBloc(
        ...
        mapRepository: gh<_i76.IMapRepository>(),
        fileRepository: gh<_i26.IFileRepository>(),
        realEstateRepository: gh<_i32.IRealEstateRepository>(),
      ));
  gh.factory<_i98.ForgotPasswordBloc>(
      () => _i98.ForgotPasswordBloc(gh<_i20.IAuthRepository>()));
  return getIt;
}

class _$GrpcModule extends _i99.GrpcModule {}

class _$CoreData extends _i100.CoreData {}

class _$InfrastructureModule extends _i101.InfrastructureModule {}
