...
class AppSize {
  ...
  /// 24.h
  static final double extraHeightDimens = 24.h;

  /// 24.w
  static final double extraWidthDimens = 24.w;
  ...
  /// 16.r
  static final double extraRadius = 16.r;

  /// 20.r
  static final double extraLargeRadius = 20.r;
  ...
  /// Icon
  /// 32.r
  static final double largeIcon = 32.r;
}
