...
mixin _$ChatMessage {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(String content, int senderId, int id, int groupId,
            @JsonKey(fromJson: fromApiDateNonNull) DateTime createdAt)
        text,
  }) =>
...
class _$ChatTextMessage implements ChatTextMessage {
  const _$ChatTextMessage(
      ...
      @JsonKey(fromJson: fromApiDateNonNull) required this.createdAt});
  ...
  @override
  String toString() {
    return 'ChatMessage.text(content: $content, senderId: $senderId, id: $id, groupId: $groupId, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, content, senderId, id, groupId, createdAt);
  ...
  TResult when<TResult extends Object?>({
    ...
    return text(content, senderId, id, groupId, createdAt);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return text?.call(content, senderId, id, groupId, createdAt);
  }
...
abstract class ChatTextMessage implements ChatMessage {
  const factory ChatTextMessage(
      ...
      @JsonKey(fromJson: fromApiDateNonNull)
          required final DateTime createdAt}) = _$ChatTextMessage;
