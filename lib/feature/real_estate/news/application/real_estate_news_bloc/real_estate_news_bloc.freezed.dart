...
mixin _$RealEstateNewsEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int month) monthChanged,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(int month)? monthChanged,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class RealEstateMonthChanged implements RealEstateNewsEvent {
  const factory RealEstateMonthChanged(final int month) =
...
// ignore: implicit_dynamic_type
  ...
  @override
  String toString() {
    return 'RealEstateNewsState(status: $status, month: $month, page: $page, canLoadMore: $canLoadMore, data: $data)';
  }
