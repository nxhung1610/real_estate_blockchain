...
/// @nodoc
abstract class $AddNewPropertyEventCopyWith<$Res> {
  factory $AddNewPropertyEventCopyWith(
          AddNewPropertyEvent value, $Res Function(AddNewPropertyEvent) then) =
      _$AddNewPropertyEventCopyWithImpl<$Res>;
}

/// @nodoc
class _$AddNewPropertyEventCopyWithImpl<$Res>
    implements $AddNewPropertyEventCopyWith<$Res> {
  _$AddNewPropertyEventCopyWithImpl(this._value, this._then);

  final AddNewPropertyEvent _value;
  // ignore: unused_field
  final $Res Function(AddNewPropertyEvent) _then;
}
...
class _$AddNewPropertyEventStart implements AddNewPropertyEventStart {
  ...
  @override
  String toString() {
    return 'AddNewPropertyEvent.started()';
  }
...
/// @nodoc
abstract class $AddNewPropertyStateCopyWith<$Res> {
...
/// @nodoc
class _$AddNewPropertyStateCopyWithImpl<$Res>
    implements $AddNewPropertyStateCopyWith<$Res> {
  _$AddNewPropertyStateCopyWithImpl(this._value, this._then);
